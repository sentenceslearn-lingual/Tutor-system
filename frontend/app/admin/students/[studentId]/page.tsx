...
export default function StudentDetailPage() {
  ...
  async function loadStudent(){
    ...
    try{
      ...
      const lessonRes =
        await fetch(
          `http://localhost:3002/lessons/student/${studentId}`,
          {
            cache:"no-store"
          }
        );
  ...
  async function deleteStudent(){
    ...
    await fetch(
      ...
      `http://localhost:3002/students/${student.studentId}`,
...
{" "}{Number(student.packagePrice || 0).toLocaleString()} THB
